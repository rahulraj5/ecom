	...
	<div class="page-content">
		...
		<!--end breadcrumb-->
			...
			<div class="row g-0">
				...
				<div class="col-md-8">
				<div class="card-body">
					<h4 class="card-title"><?php echo (!empty($product_details['product_name']) ? $product_details['product_name'] : 'none'); ?></h4>
					...
					<div class="mb-3"> 
					<span class="price h4"><?php echo (!empty($product_details['purchase_price']) ? $product_details['purchase_price'] : 'none'); ?></span> 
					<span class="text-muted">/per <?php echo (!empty($product_details['unit']) ? $product_details['unit'] : 'none'); ?></span> 
				</div>
