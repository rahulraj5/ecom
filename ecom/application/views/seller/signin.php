...
<body class="bg-login">
                        ...
                        <div class="card mt-5 mt-lg-0">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" method="POST" id="loginform" enctype="multipart/form-data">
                                            <div class="col-12">
                                                <label for="inputEmailAddress" class="form-label">Email Address</label>
                                                <input type="email" class="form-control" name="email" id="email_id" placeholder="Email Address">
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button type="button" name="submit" class="btn btn-primary admin_log"><i class="bx bxs-lock-open"></i>Sign in</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        $(".admin_log").click(function(e) {
                    // Initiate Variables With Form Content
                    var email_id = $("#email_id").val();
                    var password = $("#password").val();
                    var href = "<?php echo base_url() ?>seller/loginajax";
