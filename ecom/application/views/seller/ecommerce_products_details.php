			...
			<div class="ps-3">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb mb-0 p-0">
						...
						<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url(); ?>admin/products_list">Products List</a></li>
		...
		<div class="card">
			<div class="row g-0">
				<div class="col-md-4 border-end">
					<img src="<?php echo base_url(); ?>uploads/product/main_image/<?php echo (!empty($product_details['main_image']) ? $product_details['main_image'] : "default.png") ?>" class="img-fluid" alt="...">
					<div class="row mb-3 row-cols-auto g-2 justify-content-center mt-3">

						<div class="col"><img src="<?php echo base_url(); ?>uploads/product/thumbnail_image/<?php echo (!empty($product_details['thumbnail_image']) ? $product_details['thumbnail_image'] : "default.png") ?>" width="70" class="border rounded cursor-pointer" alt=""></div>
						
					</div>
				</div>
				<div class="col-md-8">
					<div class="card-body">
						<h4 class="card-title"><?php echo $product_details['product_name']; ?></h4>
						<?php 
						...
						<div class="mb-3">
							<span class="price h4">₹<?php echo $product_details['purchase_price']; ?></span>
							<span class="text-muted">/per <?php echo $product_details['unit']; ?></span>
						</div>
			...
			<div class="card-body">
				...
				<div class="tab-content pt-3">
					<div class="tab-pane fade show active" id="primaryhome" role="tabpanel">
						<p><?php echo $product_details['prod_description']; ?></p>
		...
		<div class="row row-cols-1 row-cols-lg-3">
			<div class="col">
				<div class="card">
					<div class="row g-0">
						<div class="col-md-4">
							<img src="<?php echo base_url(); ?>backend_assets/images/products/16.png" class="img-fluid" alt="...">
						</div>
						<div class="col-md-8">
							<div class="card-body">
			...
			<div class="col">
				<div class="card">
					<div class="row g-0">
						<div class="col-md-4">
							<img src="<?php echo base_url(); ?>backend_assets/images/products/17.png" class="img-fluid" alt="...">
						</div>
						<div class="col-md-8">
							<div class="card-body">
			...
			<div class="col">
				<div class="card">
					<div class="row g-0">
						<div class="col-md-4">
							<img src="<?php echo base_url(); ?>backend_assets/images/products/19.png" class="img-fluid" alt="...">
						</div>
						<div class="col-md-8">
							<div class="card-body">
