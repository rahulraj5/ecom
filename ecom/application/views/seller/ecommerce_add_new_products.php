									...
									<div class="row mt-3">
										<div class="col-md-6">
											<div class="col-md-12">
												...
												<input type="file" class="form-control" name="mainImage" id="mainImage" value="<?php echo (!empty($product_data) && !empty($product_data['main_image']) ? $product_data['main_image'] : "") ?>" placeholder="Enter Main Image" required>
											</div>
											<?php
										...
										<div class="col-md-6">
											<div class="col-md-12">
												...
												<input type="file" class="form-control" name="thumbnailImage" id="thumbnailImage" value="<?php echo (!empty($product_data) && !empty($product_data['thumbnail_image']) ? $product_data['thumbnail_image'] : "") ?>" placeholder="Enter Main Image" required>
											</div>
											<?php
											if (!empty($product_data)) {
											?>
