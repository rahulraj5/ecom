				...
				<div class="card radius-10">
					<div class="card-body">
						...
						<thead class="table-light">
							...
							<tbody><tr>
							<td>Iphone 5</td>
							<td><img src="<?php echo base_url();?>backend_assets/images/products/01.png" class="product-img-2" alt="product img"></td>
							<td>#9405822</td>
							...
							<tr>
							<td>Earphone GL</td>
							<td><img src="<?php echo base_url();?>backend_assets/images/products/02.png" class="product-img-2" alt="product img"></td>
							<td>#8304620</td>
							...
							<td><img src="<?php echo base_url();?>backend_assets/images/products/03.png" class="product-img-2" alt="product img"></td>
							<td>#4736890</td>
							...
							<tr>
							<td>Clasic Shoes</td>
							<td><img src="<?php echo base_url();?>backend_assets/images/products/04.png" class="product-img-2" alt="product img"></td>
							<td>#8543765</td>
							<td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Paid</span></td>
							<td>$1200.00</td>
							<td>14 Feb 2020</td>
							...
							<tr>
							<td>Sitting Chair</td>
							<td><img src="<?php echo base_url();?>backend_assets/images/products/06.png" class="product-img-2" alt="product img"></td>
							<td>#9629240</td>
							<td><span class="badge bg-gradient-blooker text-white shadow-sm w-100">Pending</span></td>
							<td>$1500.00</td>
							<td>18 Feb 2020</td>
							...
							<tr>
							<td>Hand Watch</td>
							<td><img src="<?php echo base_url();?>backend_assets/images/products/05.png" class="product-img-2" alt="product img"></td>
							<td>#8506790</td>
							<td><span class="badge bg-gradient-bloody text-white shadow-sm w-100">Failed</span></td>
							<td>$1800.00</td>
							<td>21 Feb 2020</td>
