							...
							<div class="border border-3 p-4 rounded">
								...
								<form class="row g-3" method="post" enctype="multipart/form-data">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="col-md-12">
												...
												<input type="file" class="form-control" name="mainImage" id="mainImage" value="<?php echo $product_data['main_image']; ?>" placeholder="Enter Main Image" >
											</div>
											<?php
															...
															<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
																<div class="carousel-inner">
																	<div class="carousel-item active">
																		<img src="<?php echo base_url() ?>uploads/product/main_image/<?php echo (!empty($product_data['main_image']) ? $product_data['main_image'] : "default.png") ?>" class="d-block w-100" alt="...">
																	</div>
																</div>
															</div>
														</div>
										...
										<div class="col-md-6">
											<div class="col-md-12">
												...
												<input type="file" class="form-control" name="thumbnailImage" id="thumbnailImage" value="<?php echo (!empty($product_data) && !empty($product_data['thumbnail_image']) ? $product_data['thumbnail_image'] : "") ?>" placeholder="Enter Main Image" >
											</div>
											<?php
											if (!empty($product_data)) {
											?>
													...
													<div class="card">
														<div class="card-body">
															<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
																<div class="carousel-inner">
																	<div class="carousel-item active">
																		<img src="<?php echo base_url() ?>uploads/product/thumbnail_image/<?php echo (!empty($product_data['thumbnail_image']) ? $product_data['thumbnail_image'] : "default.png") ?>" class="d-block w-100" alt="...">
																	</div>
																</div>
															</div>
														</div>
									...
									<div class="col-4">
										...
										<select class="form-select" name="videoType" id="videoType" >
									...
									<div class="col-md-6">
										...
										<input type="text" class="form-control" name="videoLink" id="videoLink" value="<?php echo (!empty($product_data) && !empty($product_data['video_link']) ? $product_data['video_link'] : "") ?>" placeholder="Enter Video Link">
									</div>
									...
									<div class="col-md-12">
										...
										<input type="text" class="form-control" name="metaTitle" id="metaTitle" value="<?php echo (!empty($product_data) && !empty($product_data['meta_title']) ? $product_data['meta_title'] : "") ?>" placeholder="Enter meta title">
									</div>

									<div class="col-md-12">
										<label for="inputMetaDescription" class="form-label">Meta Description</label>
										<textarea class="form-control" name="metaDescription" id="metaDescription" rows="3" value="<?php echo (!empty($product_data) && !empty($product_data['meta_description']) ? $product_data['meta_description'] : "") ?>" ></textarea>
									</div>
									<div class="col-md-12">
										<label for="inputMetaImage" class="form-label">Meta Image</label>
										<input type="file" class="form-control" name="metaImage" id="metaImage" placeholder="Enter image">
									</div>
									...
									<div class="col-md-12">
										<input type="hidden" name="product_id" id="product_id" value="<?php echo (!empty($product_data) && !empty($product_data['product_id']) ? $product_data['product_id'] : "") ?>">
