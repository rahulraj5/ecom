											...
											<div class="card-body">
												<div class="d-flex align-items-center">
													...
													<div class="user-groups ms-auto">
														<img src="<?php echo base_url();?>backend_assets/images/avatars/avatar-1.png" width="35" height="35" class="rounded-circle" alt="" />
														<img src="<?php echo base_url();?>backend_assets/images/avatars/avatar-2.png" width="35" height="35" class="rounded-circle" alt="" />
													</div>
										...
										<div class="card shadow-none border radius-15">
											<div class="card-body">
												<div class="d-flex align-items-center">
													...
													<div class="user-groups ms-auto">
														<img src="<?php echo base_url();?>backend_assets/images/avatars/avatar-4.png" width="35" height="35" class="rounded-circle" alt="" />
													</div>
												</div>
										...
										<div class="card shadow-none border radius-15">
											<div class="card-body">
												<div class="d-flex align-items-center">
													...
													<div class="user-groups ms-auto">
														<img src="<?php echo base_url();?>backend_assets/images/avatars/avatar-7.png" width="35" height="35" class="rounded-circle" alt="" />
														<img src="<?php echo base_url();?>backend_assets/images/avatars/avatar-8.png" width="35" height="35" class="rounded-circle" alt="" />
													</div>
												</div>
