            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Paypal Details</li>
                    </ol>
                </nav>
            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="border border-3 p-4 rounded">
                                <form action="" method="post" id="paypal_form">
                                    <div class="mb-3">
                                        <label for="mailDriver" class="form-label">Client ID</label>
                                        <input type="text" class="form-control" name="clientId" id="clientId" placeholder="Enter Client ID">
                                    </div>
                                    <div class="mb-3">
                                        <label for="mailHost" class="form-label">Client Secret</label>
                                        <input type="text" class="form-control" name="clientSecret" id="clientSecret" placeholder="Enter Client Secret">
                                    </div>
                                    <div class="mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" value="1" name="sBmode" id="sBmode" checked>
                                            <label class="form-check-label" for="sandBoxmode">Switched Off the Sandbox mode (demo)</label>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <input type="hidden" name="h_paypal" id="h_paypal" value="1">
                                        <button type="button" class="btn btn-primary px-5 paypal_btn">Submit</button>
                                    </div>
                                </form>
                                        ...
                                        <div class="col-sm py-2">
                                            <div class="card radius-15">
                                                <div class="card-body">
                                                    ...
                                                    <b>Client ID</b> - <span>id</span><hr>
                                                    <b>Client Secret</b> - <span>*****</span><hr>
                                                </div>
                                            </div>
                                        </div>
