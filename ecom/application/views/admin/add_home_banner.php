					...
					<div class="card">
						<div class="card-body">
							<form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img src="<?php echo base_url() ?>uploads/home/banner/<?php echo (!empty($b_data['banner']) ? $b_data['banner'] : "default.png") ?>" class="d-block w-100" alt="...">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
								...
								?>
								<div class="mb-3">
									<input type="hidden" name="id" value="<?php echo (!empty($b_data) && !empty($b_data['id']) ? $b_data['id'] : "") ?>">
