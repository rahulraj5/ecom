							...
							<div class="card-body">
								<div class="p-4 border rounded">
									<form class="row g-3 enctype="multipart/form-data" id="category_form" method="post" action="">
										...
										<div class="col-12">
											<input type="hidden" id="categories_id" name="categories_id" value="<?php echo (!empty($cat_data) && !empty($cat_data['categories_id']) ? $cat_data['categories_id'] : "" )?>">
											<button type="button" class="btn btn-primary asCat">Add</button>
										</div>
									</form>
								</div>
							</div>
